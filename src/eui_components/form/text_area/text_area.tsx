...
// @internal
export type EuiCompressedTextAreaProps = Omit<EuiTextAreaProps, 'compressed'>;

// @internal
export const EuiCompressedTextArea: FunctionComponent<EuiCompressedTextAreaProps> = (
  props
) => <EuiTextArea {...props} compressed />;
