...
export const EuiSelect: FunctionComponent<EuiSelectProps> = ({
  ...
  const handleMouseUp = (e: React.MouseEvent<HTMLSelectElement>) => {
    ...
    // See https://github.com/elastic/oui/pull/1926 for full discussion on
...
// @internal
export type EuiCompressedSelectProps = Omit<EuiSelectProps, 'compressed'>;

// @internal
export const EuiCompressedSelect: FunctionComponent<EuiCompressedSelectProps> = (
  props
) => <EuiSelect {...props} compressed />;
