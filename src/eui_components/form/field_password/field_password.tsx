...
// @internal
export type EuiCompressedFieldPasswordProps = Omit<
  EuiFieldPasswordProps,
  'compressed'
>;

// @internal
export const EuiCompressedFieldPassword: FunctionComponent<EuiFieldPasswordProps> = (
  props
) => <EuiFieldPassword {...props} compressed />;
