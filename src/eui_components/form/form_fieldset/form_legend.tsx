...
// @internal
export type EuiCompressedFormLegendProps = Omit<
  EuiFormLegendProps,
  'compressed'
>;

// @internal
export const EuiCompressedFormLegend: FunctionComponent<EuiCompressedFormLegendProps> = (
  props
) => <EuiFormLegend {...props} compressed />;
