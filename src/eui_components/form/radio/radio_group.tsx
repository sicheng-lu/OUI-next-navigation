...
// @internal
export type EuiCompressedRadioGroupProps = CommonProps & {
  disabled?: boolean;
  name?: string;
  options: EuiRadioGroupOption[];
  idSelected?: string;
...
// @internal
export const EuiCompressedRadioGroup: FunctionComponent<EuiCompressedRadioGroupProps> = (
  props
) => <EuiRadioGroup {...props} compressed />;
