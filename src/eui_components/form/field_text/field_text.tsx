...
// @internal
export type EuiCompressedFieldTextProps = Omit<EuiFieldTextProps, 'compressed'>;

// @internal
export const EuiCompressedFieldText: FunctionComponent<EuiCompressedFieldTextProps> = (
  props
) => <EuiFieldText {...props} compressed />;
