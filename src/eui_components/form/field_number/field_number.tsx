...
// @internal
export type EuiCompressedFieldNumberProps = Omit<
  EuiFieldNumberProps,
  'compressed'
>;

// @internal
export const EuiCompressedFieldNumber: FunctionComponent<EuiCompressedFieldNumberProps> = (
  props
) => <EuiFieldNumber {...props} compressed />;
