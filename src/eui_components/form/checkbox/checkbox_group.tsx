...
// @internal
export type EuiCompressedCheckboxGroupProps = CommonProps & {
  options: EuiCheckboxGroupOption[];
  idToSelectedMap: EuiCheckboxGroupIdToSelectedMap;
  onChange: (optionId: string) => void;
  disabled?: boolean;
...
// @internal
export const EuiCompressedCheckboxGroup: FunctionComponent<EuiCompressedCheckboxGroupProps> = (
  props
) => <EuiCheckboxGroup {...props} compressed />;
