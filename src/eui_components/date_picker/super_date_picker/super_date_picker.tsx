...
> {
        ...
        <EuiDatePickerRange
          ...
          <button
            className={classNames('euiSuperDatePicker__prettyFormat', {
              ...
              'euiSuperDatePicker__prettyFormat--compressed': compressed,
            })}
            ...
            startDateControl={
              <EuiDatePopoverButton
                className={classNames(
                  ...
                  {
                    'euiSuperDatePicker__startPopoverButton--compressed': compressed,
                  }
                )}
                position="start"
  ...
  render() {
    ...
    const flexWrapperClasses = classNames('euiSuperDatePicker__flexWrapper', {
      ...
      'euiSuperDatePicker__flexWrapper--isOpen':
        this.state.isStartDatePopoverOpen ||
        this.state.isEndDatePopoverOpen ||
        this.state.isQuickSelectOpen,
      'euiSuperDatePicker__flexWrapper--hasInteracted': this.state
        .hasInteracted,
    });
...
// @internal
export type EuiCompressedSuperDatePickerProps = Omit<
  EuiSuperDatePickerProps,
  'compressed'
>;

// @internal
export class EuiCompressedSuperDatePicker extends EuiSuperDatePicker {
  static defaultProps = {
