...
import ReactDatePicker, { ReactDatePickerProps } from '../../components/date_picker/react-datepicker'; // eslint-disable-line import/no-unresolved
...
type _EuiDatePickerProps = CommonProps &
  Omit<
    EuiExtendedDatePickerProps,
    | 'monthsShown'
    | 'showWeekNumbers'
    | 'fixedHeight'
    | 'dropdownMode'
