...
export interface EuiSearchInputProps
  extends CommonProps,
...
export const EuiSearchInput: FunctionComponent<EuiSearchInputProps> = ({
  ...
  const renderPlaceholder = () => {
    ...
    if (!placeholderHighlight || !placeholder.includes(placeholderHighlight)) {
      return (
        <div className="euiSearchInput__placeholder">
          <span className="euiSearchInput__caret" />
          {placeholder}
        </div>
      );
    }
    ...
    return (
      <div className="euiSearchInput__placeholder">
        <span className="euiSearchInput__caret" />
        {before}
        <span className="euiSearchInput__highlight">
          {placeholderHighlight}
        </span>
        {after}
      </div>
  ...
  const classes = classNames(
    'euiSearchInput',
    {
      'euiSearchInput--fullWidth': fullWidth,
      'euiSearchInput--disabled': isDisabled,
    },
    className
  );
  ...
  return (
    <div className={classes} {...rest}>
      <div className="euiSearchInput__card">
        {renderPlaceholder()}
        <textarea
          ref={textareaRef}
          className={classNames('euiSearchInput__textarea', {
            'euiSearchInput__textarea--empty': !currentValue,
          })}
          value={currentValue}
        ...
        />
        <div className="euiSearchInput__actions">
          {actionsLeft && (
            <div className="euiSearchInput__actionsLeft">{actionsLeft}</div>
          )}
          {actionsRight && (
            <div className="euiSearchInput__actionsRight">{actionsRight}</div>
          )}
        </div>
      </div>
    </div>
...
EuiSearchInput.displayName = 'EuiSearchInput';
