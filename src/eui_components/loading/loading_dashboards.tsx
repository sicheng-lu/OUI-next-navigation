...
const sizeToClassNameMap = {
  m: 'euiLoadingDashboards--medium',
  l: 'euiLoadingDashboards--large',
  xl: 'euiLoadingDashboards--xLarge',
  xxl: 'euiLoadingDashboards--xxLarge',
};

export const SIZES = keysOf(sizeToClassNameMap);

export interface EuiLoadingDashboardsProps {
  size?: keyof typeof sizeToClassNameMap;
}

export const EuiLoadingDashboards: FunctionComponent<
  CommonProps & HTMLAttributes<HTMLDivElement> & EuiLoadingDashboardsProps
