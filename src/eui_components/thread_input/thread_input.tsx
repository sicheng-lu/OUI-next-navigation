...
export interface EuiThreadInputProps
  extends CommonProps,
...
export const EuiThreadInput: FunctionComponent<EuiThreadInputProps> = ({
  ...
  const classes = classNames(
    'euiThreadInput',
    {
      'euiThreadInput--fullWidth': fullWidth,
      'euiThreadInput--disabled': isDisabled,
    },
    className
  );
  ...
  return (
    <div className={classes} {...rest}>
      <div className="euiThreadInput__wrapper">
        <textarea
          className="euiThreadInput__textarea"
        ...
        />
        <div className="euiThreadInput__actions">
          {actionsLeft && (
            <div className="euiThreadInput__actionsLeft">{actionsLeft}</div>
          )}
          {actionsRight && (
            <div className="euiThreadInput__actionsRight">{actionsRight}</div>
          )}
        </div>
      </div>
    </div>
...
EuiThreadInput.displayName = 'EuiThreadInput';
