...
// @internal
export type EuiCompressedColorPickerProps = Omit<
  EuiColorPickerProps,
  'compressed'
>;

// @internal
export const EuiCompressedColorPicker: FunctionComponent<EuiCompressedColorPickerProps> = (
  props
) => <EuiColorPicker {...props} compressed />;
