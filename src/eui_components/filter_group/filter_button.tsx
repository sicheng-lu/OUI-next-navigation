...
// @internal
export type EuiSmallFilterButtonProps = EuiSmallButtonEmptyProps & {
  /**
   * Bolds the button if true
   */
  hasActiveFilters?: boolean;
...
// @internal
export const EuiSmallFilterButton: FunctionComponent<EuiSmallFilterButtonProps> = (
  props
) => <EuiFilterButton {...props} size="s" />;
