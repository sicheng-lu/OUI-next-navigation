...
export type EuiSmallButtonProps = Omit<EuiButtonProps, 'size'>;

// Cannot Omit<Props, 'size'> directly due to Exclude changing optional prop types
type SmallProps = ExclusiveUnion<
  Omit<EuiButtonPropsForAnchor, 'size'>,
  Omit<EuiButtonPropsForButton, 'size'>
>;

export const EuiSmallButton: FunctionComponent<SmallProps> = (props) => (
  <EuiButton {...props} size="s" />
);

export type EuiXSmallButtonProps = Omit<EuiButtonProps, 'size'>;
...
export const EuiXSmallButton: FunctionComponent<XSmallProps> = (props) => (
  <EuiButton {...props} size="xs" />
);
