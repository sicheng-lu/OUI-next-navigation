...
// @internal
export type EuiSmallButtonEmptyProps = ExclusiveUnion<
  Omit<EuiButtonEmptyPropsForAnchor, 'size'>,
  Omit<EuiButtonEmptyPropsForButton, 'size'>
>;

// @internal
export const EuiSmallButtonEmpty: FunctionComponent<EuiSmallButtonEmptyProps> = (
  props
