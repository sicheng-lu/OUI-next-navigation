...
// @internal
export type EuiSmallButtonIconProps = Omit<EuiButtonIconProps, 'size'>;

// @internal
type SmallProps = ExclusiveUnion<
  Omit<EuiButtonIconPropsForAnchor, 'size'>,
  Omit<EuiButtonIconPropsForButton, 'size'>
>;

// @internal
export const EuiSmallButtonIcon: FunctionComponent<SmallProps> = (props) => (
  <EuiButtonIcon {...props} size="s" />
);
