...
// TODO - replace with variables once https://github.com/elastic/oui/issues/2731 is closed
const colorInk = '#000';
...
const colorToHexMap: { [color in IconColor]: string } = {
  // TODO - replace with variable once https://github.com/elastic/oui/issues/2731 is closed
  default: '#d3dae6',
  primary: visColors[1],
  success: visColors[0],
...
export const EuiBadge: FunctionComponent<EuiBadgeProps> = ({
  ...
  const classes = classNames(
    'euiBadge',
    {
      ...
      [`euiBadge--${color}`]: COLORS.indexOf(color) > -1,
    },
