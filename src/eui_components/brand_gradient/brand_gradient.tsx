...
export type EuiBrandGradientVariant = 'subtle' | 'vivid' | 'radial' | 'satin';

export interface EuiBrandGradientProps
  extends CommonProps,
   ...
   */
  variant?: EuiBrandGradientVariant;
  /**
...
export const EuiBrandGradient: FunctionComponent<EuiBrandGradientProps> = ({
  variant = 'subtle',
  isDark = false,
  fullScreen = false,
  className,
  ...
  const classes = classNames('euiBrandGradient', className);
...
EuiBrandGradient.displayName = 'EuiBrandGradient';
