  ...
  return (
    <div style={{
      ...
      <div style={{ marginTop: 10 }}>
        <V10PersonAvatar initial="J" color={useV10T().red} size={28}/>
      </div>
    </div>
  );
}
...
function ChatHeader() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        flex: 1,
        fontFamily: V10_FONT_SANS, fontSize: 14.5, fontWeight: 600,
...
function ChatPara({ children }) {
  ...
  return (
    <p style={{
      margin: 0,
      fontFamily: V10_FONT_SANS, fontSize: 14.5, color: T.ink,
...
function ChatHeading({ children }) {
  ...
  return (
    <div style={{
      fontFamily: V10_FONT_SANS, fontSize: 14.5, fontWeight: 700,
      color: T.inkBright, lineHeight: 1.4, letterSpacing: -0.1,
    }}>{children}</div>
  );
}

function ArtifactCard({ title, body, accent }) {
  const T = useV10T();
  ...
  return (
    <div style={{
      ...
      <V10CornerTicks accent={c}/>
      <div style={{
        fontFamily: V10_FONT_SANS, fontSize: 13.5, fontWeight: 700,
        color: T.inkBright, letterSpacing: -0.1, marginBottom: 6,
      }}>{title}</div>
      <div style={{
        fontFamily: V10_FONT_SANS, fontSize: 12.5, color: T.inkDim,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        fontFamily: V10_FONT_MONO, fontSize: 9, color: T.inkDim, letterSpacing: 1,
      }}>
        {bars.map((b, i) => (
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{
          fontFamily: V10_FONT_MONO, fontSize: 12.5, fontWeight: 700,
...
function SuggestedAction({ children }) {
  ...
  return (
    <div style={{
      ...
      background: T.panel,
      color: T.ink,
      fontFamily: V10_FONT_SANS, fontSize: 13, fontWeight: 500,
      letterSpacing: -0.05,
      display: 'flex', alignItems: 'center', justifyContent: 'space-between',
      cursor: 'pointer',
    }}>
  ...
  return (
    <ul style={{
      ...
      {items.map((item, i) => (
        <li key={i} style={{
          display: 'flex', gap: 10,
          fontFamily: V10_FONT_SANS, fontSize: 14, color: T.ink,
          lineHeight: 1.5, letterSpacing: -0.05,
        }}>
          <span style={{
            color: T.cyan, fontFamily: V10_FONT_MONO, fontSize: 12,
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            fontFamily: V10_FONT_SANS, fontSize: 14, color: T.inkDim,
          }}>
            Ask anything. Type <span style={{ fontFamily: V10_FONT_MONO, color: T.cyan, padding: '0 4px', border: `1px solid ${T.cyanDim}` }}>/</span> for actions.
          </div>
          <div style={{
            display: 'flex', alignItems: 'center', justifyContent: 'space-between',
            marginTop: 8,
...
function CanvasTab({ icon, label, active, onClose }) {
  const T = useV10T();
  return (
    <div style={{
...
function CanvasTabBar({ mode, setMode }) {
  const T = useV10T();
  const alertIcon = (
  ...
  return (
    <div style={{
      ...
      <CanvasTab icon={alertIcon} label="Alert: P95 Latency > 2s" active onClose={() => {}}/>
      <CanvasTab icon={docIcon} label="Inventory service depen..."/>
      <CanvasTab icon={docIcon} label="Payment service connec..."/>
      <span style={{
...
function P99LineChart() {
  const T = useV10T();
  const pts = [
    { x: 0, v: 220 }, { x: 0.5, v: 215 }, { x: 1, v: 230 }, { x: 1.5, v: 240 },
    { x: 2, v: 280 }, { x: 2.5, v: 360 }, { x: 3, v: 520 }, { x: 3.5, v: 760 },
    { x: 4, v: 1100 }, { x: 4.5, v: 1500 }, { x: 5, v: 1900 }, { x: 5.5, v: 2050 }, { x: 6, v: 2200 },
  ];
  const W = 760, H = 240;
  ...
  return (
    <div style={{
      ...
      <V10CornerTicks/>
      <div style={{
        fontFamily: V10_FONT_SANS, fontSize: 14, fontWeight: 600,
        ...
        {yLabels.map(v => {
          ...
          return (
            <g key={v}>
              ...
              <text x={PADL - 6} y={y + 3} fontFamily={V10_FONT_MONO} fontSize="10" fill={T.inkDim} textAnchor="end" letterSpacing="0.3">{v}ms</text>
            </g>
          );
        })}
        {xLabels.map(x => (
          <text key={x} x={sx(x)} y={H - 10} fontFamily={V10_FONT_MONO} fontSize="10" fill={T.inkDim} textAnchor="middle">{x}</text>
        ))}
...
function AlarmBanner() {
  ...
  return (
    <div style={{
      ...
      <span style={{
        fontFamily: V10_FONT_SANS, fontSize: 13.5, color: T.ink, lineHeight: 1.4, letterSpacing: -0.05,
      }}>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          margin: 0, flex: 1,
          fontFamily: V10_FONT_SANS, fontSize: 22, fontWeight: 600,
      ...
      <div style={{ marginBottom: 16 }}>
        <V10SectionLabel>SUMMARY</V10SectionLabel>
        <div style={{
          fontFamily: V10_FONT_SANS, fontSize: 14, color: T.ink, lineHeight: 1.55, letterSpacing: -0.05,
        }}>
      ...
      <div>
        <V10SectionLabel>RECOMMENDATION</V10SectionLabel>
        <BulletList items={[
...
function CanvasPanel({ mode, setMode }) {
  ...
  return (
    <div style={{
      ...
      <CanvasTabBar mode={mode} setMode={setMode}/>
      <CanvasContent/>
    </div>
  );
}

// ─── Dashboard Content (reusable — no left rail, parent provides it) ──

export function V10DashboardContent({ mode, setMode, onBack }) {
  return (
...
// ─── Dashboard Page (standalone route) ─────────────────────────

export function V10DashboardPage() {
  const { mode, setMode, T } = useV10Theme();
  return (
    <V10ThemeContext.Provider value={T}>
      <V10PageBackground marks={false}>
        <V10DashboardContent mode={mode} setMode={setMode}/>
      </V10PageBackground>
